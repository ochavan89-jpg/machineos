        ...
        <div style={ms.overlay} onClick={() => setMenuOpen(false)}>
          <div style={ms.drawer} onClick={e => e.stopPropagation()}>
            ...
            <div style={ms.drawerHeader}>
              ...
              <div style={{ flex: 1 }}>
                <p style={ms.drawerTitle}>{title || 'Development Express'}</p>
            ...
            <div style={{ height: '1px', background: 'rgba(201,168,76,0.15)', margin: '4px 0' }} />
            ...
            {/* Bottom Content */}
            {bottomContent && (
              <div style={{ padding: '12px 16px', borderTop: '1px solid rgba(201,168,76,0.15)' }}>
                {bottomContent}
              </div>
            )}
          </div>
...
const ms = {
  topbar: {
    ...
    alignItems: 'center', height: '56px', boxSizing: 'border-box',
  },
  ...
  logoCircle: {
    ...
    justifyContent: 'center', fontWeight: '900', color: '#0a1628',
  ...
  hamburger: {
    ...
    color: '#c9a84c', borderRadius: '8px', padding: '6px 12px',
  ...
  drawer: {
    width: '280px', background: 'linear-gradient(180deg, #0f2040, #0a1628)',
    height: '100%', display: 'flex', flexDirection: 'column',
    overflowY: 'hidden', boxShadow: '4px 0 20px rgba(0,0,0,0.5)',
  },
  drawerHeader: {
    display: 'flex', alignItems: 'center', gap: '10px',
    padding: '16px', borderBottom: '1px solid rgba(201,168,76,0.2)',
  ...
  closeBtn: {
    background: 'transparent', border: 'none', color: '#8896a8',
    fontSize: '18px', cursor: 'pointer', padding: '4px', flexShrink: 0,
  },
  nav: {
    display: 'flex', alignItems: 'center', gap: '12px',
    padding: '12px 14px', borderRadius: '8px', border: 'none',
    background: 'transparent', color: '#8896a8', cursor: 'pointer',
    fontSize: '14px', width: '100%', textAlign: 'left', marginBottom: '2px',
  },
  navActive: {
    display: 'flex', alignItems: 'center', gap: '12px',
    ...
    textAlign: 'left', fontWeight: '700', marginBottom: '2px',
  },
  badge: {
    marginLeft: 'auto', background: '#e94560', color: '#fff',
    fontSize: '10px', borderRadius: '50%', width: '18px', height: '18px',
  ...
  bottomBar: {
    ...
    alignItems: 'center', padding: '6px 0', height: '58px',
  },
  bottomItem: {
    display: 'flex', flexDirection: 'column', alignItems: 'center',
    gap: '2px', background: 'transparent', border: 'none',
    cursor: 'pointer', padding: '4px 8px', borderRadius: '8px', minWidth: '50px',
  },
};
